            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <section className="bg-white p-8 rounded-2xl border border-zinc-200 shadow-sm">
                <div className="flex justify-between items-center mb-6">
                  <h2 className="text-xl font-bold text-zinc-900">Vocabulario de la semana</h2>
                  {isGenerating && (
                    <div className="flex items-center gap-2 text-[#F57C00] animate-pulse">
                      <Loader2 size={16} className="animate-spin" />
                      <span className="text-xs font-bold uppercase">Generando Actividades IA...</span>
                    </div>
                  )}
                </div>
                      ...
                      <div className="p-6 rounded-2xl border border-zinc-100 bg-zinc-50/50">
                        <div className="flex justify-between items-start mb-4">
                          ...
                          <div className="flex items-center gap-1 text-emerald-600">
                            <Sparkles size={16} />
                            <span className="text-[10px] font-bold uppercase">AI Enhanced</span>
                          </div>
                        </div>
                ...
                <div className="mt-12 p-4 bg-orange-50 rounded-xl border border-orange-100 flex gap-3 items-center">
